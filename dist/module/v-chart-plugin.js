        ...
        generateLegend: function generateLegend(cs) {
          ...
          if (this.chartData.legends && this.chartData.legends.enabled === true) {
            ...
            this.metric.forEach(function (e, i) {
              ...
              d3.select('#' + _this.chartData.selector).append("g").attr("class", "legends").append("rect").attr('x', _this.width - 40).attr('y', _this.height * 0.99 - i * 15 - 10).attr("width", 30).attr("height", 10).style("fill", function () {
